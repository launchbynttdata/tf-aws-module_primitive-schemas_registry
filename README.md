...
This Terraform module creates an [AWS EventBridge Schema Registry](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/schemas_registry) resource.
...
| Name | Type |
|------|------|
| [aws_schemas_registry.registry](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/schemas_registry) | resource |
...
| <a name="input_name"></a> [name](#input\_name) | Name of the schema registry. Must be between 1 and 64 characters and may contain letters, numbers, hyphens, underscores, and periods. | `string` | n/a | yes |
